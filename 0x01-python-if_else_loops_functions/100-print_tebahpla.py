...
# -----------------------------------------------------------
# Python program that:
# demonstrates how to print prints the ASCII alphabet, in reverse order, alternating lowercase and 
# uppercase (z in lowercase and Y in uppercase)
# demonstrates how to use a loop and an if...elif condition to affect program output
#
